<div>
    ...
    <div class="flex bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 mb-6">
                            <a href="{{ route('post.show',['username' => $post->user->username, 'post' => $post->slug]) }}" class="flex-shrink-0 mt-6">
                                <img class="w-32 h-32 object-cover rounded-t-lg" src="{{ $post->user->imageUrl() }}" alt="" />
                            </a>
                            <div class="p-5">
